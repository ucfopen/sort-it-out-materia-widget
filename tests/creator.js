describe('SortItOut', function() {
	...
	describe('Creator Controller', function() {
		...
		it('should have the folders in the correct order', function() {
			expect($scope.folders[0].name).toBe("College of Arts and Humanities");
			expect($scope.folders[1].name).toBe("College of Business Administration");
			expect($scope.folders[2].name).toBe("College of Community Innovation and Education");
			expect($scope.folders[3].name).toBe("College of Engineering and Computer Science");
			expect($scope.folders[4].name).toBe("College of Health Professions and Sciences");
		});
		...
		it('should save the widget properly', function() {
			...
			expect(successReport).toBe($scope.title);
